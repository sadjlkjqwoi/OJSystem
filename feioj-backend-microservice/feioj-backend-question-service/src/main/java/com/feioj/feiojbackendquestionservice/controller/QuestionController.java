package com.feioj.feiojbackendquestionservice.controller;
...
import com.feioj.feiojbackendjudgeservice.annotation.AuthCheck;
import com.feioj.feiojbackendjudgeservice.common.BaseResponse;
import com.feioj.feiojbackendjudgeservice.common.DeleteRequest;
import com.feioj.feiojbackendjudgeservice.common.ErrorCode;
import com.feioj.feiojbackendjudgeservice.common.ResultUtils;
import com.feioj.feiojbackendjudgeservice.constant.UserConstant;
import com.feioj.feiojbackendjudgeservice.exception.BusinessException;
import com.feioj.feiojbackendjudgeservice.exception.ThrowUtils;
import com.feioj.feiojbackendmodel.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<Boolean> editQuestion(@RequestBody QuestionEditRequest questionEditRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可编辑
        if (!question1.getUserId().equals(loginUser.getId()) && !userFeignClient.isAdmin(loginUser)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
        boolean result = questionService.updateById(question);
        return ResultUtils.success(result);
...
//    @AuthCheck(mustRole = UserConstant.USER_LOGIN_STATE)
    public BaseResponse<Page<QuestionSubmitVo>> listQuestionSubmitByPage(@RequestBody QuestionSubmitQueryRequest questionSubmitQueryRequest, HttpServletRequest request) {
        ...
        Page<QuestionSubmit> questionPage = questionSubmitService.page(new Page<>(current, size), queryWrappers);
